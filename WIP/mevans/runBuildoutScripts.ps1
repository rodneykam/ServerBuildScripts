...
.DESCRIPTION
	...
	$runLocal indicates that the scripts should be executed only on the server that this seript is bieng executed on.
	
	$noDatabase indicates that the services should not be started
