...
$name=$computer.name
Write-host -ForegroundColor Green "`nStart Script - createSharedFolders on server $name`n"
...
Write-host -ForegroundColor Green "`nEnd Script - createSharedFolders on server $name`n"
